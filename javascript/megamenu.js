...
function additional_menu(){
	$(".nsmenu-bigblock-additional").css('width',$(".menu-header-box").outerWidth()-30);
...
function mmpro_aim_h(){
	if (viewhw().width >= 768) {
		$('#horizontal-menu a.dropdown-toggle, div.dropdown-menu').mouseover(function() {
			nsmenu_menu();
			$(this).parent().addClass('open');
			$('#horizontal-menu').addClass('active-mask');
